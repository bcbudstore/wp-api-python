...
Appreciatively forked by BCBud to add oauth2 password grant type token request support, token-based authentication using Authentication: Bearer < > headers, as well as any GUI dialogs necessary to gather any necessary credentials.
